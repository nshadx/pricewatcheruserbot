...
1. Бот будет просить телефон, код доступа с почты, телефоны... whatever. Их нужно вводить при первом запуске приложения в тоже самое окно терминала после установки. 
